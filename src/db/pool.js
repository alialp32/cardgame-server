 ...
 * Render + cPanel remote MySQL uyumlu.
...
const pool = mysql.createPool({
  host: envStr('DB_HOST', 'batman.wlsrv.com'),
  port: envInt('DB_PORT', 3306),
  user: envStr('DB_USER', 'simurghc_cardgame'),
  password: envStr('DB_PASSWORD', '1453a1453A@'),
  database: envStr('DB_NAME', 'simurghc_cardgame'),
